...
public class ModelPalavras extends AbstractTableModel {

	private List<Palavra> dados;
	private String[] colunas = { "Indentificador","Nome", "Numero Ocorrencia", "Quant Provas"};
	...
	public ModelPalavras() {
		dados = new ArrayList<Palavra>();

	}

	public void addRow(Palavra p) {
	...
	public Object getValueAt(int linha, int coluna) {
		...
		case 3:
			return dados.get(linha).getQuantProvas();
